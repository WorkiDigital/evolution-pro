...
export default {
  ...
  crm: {
    ...
    subtitle: "Gerencie leads, acompanhe oportunidades e feche mais negócios",
    badge: "CRM Premium",
    newLead: "Novo Lead",
    ...
    form: {
      ...
      tags: "Tags",
      tagsHint: "Pressione Enter para adicionar tags",
    ...
    messages: {
      leadMoved: "Lead movido com sucesso!",
      leadSaved: "Lead salvo com sucesso!",
      leadDeleted: "Lead excluído com sucesso!",
      contactsImported: "contato(s) importado(s)!",
      alreadyExists: "já existia(m)",
      dataUpdated: "Dados atualizados!"
    },
    importContacts: {
      title: "Importar Contatos para CRM",
      loading: "Carregando contatos...",
      searchPlaceholder: "Buscar contatos...",
      selectAll: "Selecionar Todos",
      deselectAll: "Desmarcar Todos",
      selected: "contatos selecionados",
      alreadyInCRM: "Já no CRM",
      noContacts: "Nenhum contato encontrado nesta instância.",
      import: "Importar",
      cancel: "Cancelar"
    },
    views: {
    ...
    automations: {
      ...
      triggers: {
        ...
        stage_change: "Lead mudou de estágio",
        inactivity: "Lead sem atividade",
    ...
    analytics: {
      ...
      valueByStage: "Valor por Estágio",
      leadsTrend: "Tendência de Leads",
      sourceDistribution: "Origem dos Leads",
