...
export default {
  ...
  crm: {
    ...
    subtitle: "Manage leads, track opportunities and close more deals",
    badge: "Premium CRM",
    newLead: "New Lead",
    editLead: "Edit Lead",
    filters: "Filters",
    ...
    messages: {
      leadMoved: "Lead moved successfully!",
    ...
    importContacts: {
      ...
      noContacts: "No contacts found in this instance.",
      import: "Import",
      cancel: "Cancel"
    },
    views: {
